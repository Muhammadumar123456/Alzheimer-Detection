        ...
        <>
          ...
          >
            <div className="p-6">
              ...
              {/* User Info */}
              <motion.div className="mb-8 p-5 bg-white rounded-2xl shadow-md" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
                <div className="flex items-center gap-3">
                  <motion.div className="w-14 h-14 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg" whileHover={{ scale: 1.05, rotate: 360 }} transition={{ duration: 0.5 }}>
                    <User className="w-7 h-7 text-white" />
                  </motion.div>
              ...
              <div className="space-y-3">
                {menuItems.map((item) => (
                  <motion.button
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: item.delay }}
                    whileHover={{ x: 8, scale: 1.03, backgroundColor: '#f0ebff', color: '#6b21a8' }}
                    className="w-full flex items-center gap-3 px-5 py-3 text-gray-700 bg-white hover:bg-purple-50 hover:text-purple-700 rounded-lg font-medium transition-all shadow-sm"
                    onClick={() => { item.action(); setIsSidebarOpen(false); }}
                  >
                    <item.icon className="w-5 h-5 text-purple-600" />
