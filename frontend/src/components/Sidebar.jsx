              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="overflow-hidden">
                    <p className="font-semibold text-gray-800 truncate">{isAuthenticated ? (user?.name || 'User') : 'Guest'}</p>
                    <p className="text-sm text-gray-500 truncate">{isAuthenticated ? (user?.email || '') : 'Not signed in'}</p>
                  </div>
                </div>
              </motion.div>
              ...
              <div className="space-y-2">
                ...
                {isAuthenticated ? (
                  ...
                  <motion.button
                    ...
                    className="w-full flex items-center gap-3 px-5 py-3 text-white bg-purple-600 hover:bg-purple-700 rounded-lg font-medium transition-all shadow-md mt-4"
